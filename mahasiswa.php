<?php
    ...
    $mhs = query("SELECT * FROM mhs ORDER BY nrp ASC");
?>
    ...
    <div class="row no-gutters mt-5">
        <div class="col-md-2 bg-dark mt-2 pr-3 pt-4 position-fixed" style="z-index: 0;">
            <ul class="nav flex-column ml-3">
                ...
                <li class="nav-item">
                    <a class="nav-link active text-white" href="mahasiswa.php?username=<?= $user["username"] ?>"><i class="fa-solid fa-graduation-cap mr-2"></i>Daftar Mahasiswa</a><hr class="bg-secondary">
                </li>
                <li class="nav-item">
        ...
        <div class="col-md-10 p-5 pt-2" style="left: 220px;">
            <h3><i class="fa-solid fa-graduation-cap mr-2"></i> Daftar Mahasiswa</h3><hr>
            <div class="d-flex">
                <?php if($user["role"] == "admin") : ?>
                    <a href="daftar_mhs.php" class="btn btn-primary mb-3"><i class="fa-solid fa-plus mr-2"></i>Tambah Data Mahasiswa</a>
                <?php endif; ?>
                <form action="" method="post" class="form-inline my-2 my-lg-0 ml-auto pb-3">
                    ...
                    <button id="tombol-cari" class="btn btn-outline-primary my-2 my-sm-0" type="submit">Search</button>
                </form>
            </div>
            <div id="kontainer">
